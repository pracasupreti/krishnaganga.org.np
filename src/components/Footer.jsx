  ...
  return (
    <>
      <footer className='bg-[#32302f] p-4'>
        <section className='container mx-auto lg:flex gap-10 text-[#8f8b89] text-sm flex-col lg:flex-row text-center lg:text-start'>
          <div className='flex flex-col gap-4 lg:w-[50%]'>
            <h2 className='text-[#ecc731] text-[30px] font-bold'><em>About Us</em></h2>
            <p className='text-justify'>Situated in the heart of Biratnagar, HOPE TRUST, Krishna Ganga Drug & Alcohol Deaddiction & Rehabilitation Center, offers expert care for those battling addiction. Our dedicated team provides personalized treatment programs focused on long-term recovery. We help individuals rebuild their lives in a supportive and compassionate environment.</p>
          ...
          <div className='w-full mt-8 lg:mt-0'>
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7144.126503763646!2d87.273179!3d26.45369!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39ef744541d01bd3%3A0x57b7ceeeaf08f255!2sJanpath%20Tole%2C%20Biratnagar%2056613%2C%20Nepal!5e0!3m2!1sen!2sus!4v1743088161667!5m2!1sen!2sus" width="100%" height={300} style={{border: 0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
          </div>
        </section>
      </footer>
      ...
      <section className='bg-[#2a2928] py-5 px-3'>
        <div className='lg:flex justify-between container mx-auto text-[#cccc] text-[15px] flex-col lg:flex-row'>
          ...
          <p className='text-center lg:text-right mt-4 lg:mt-0'>
            Technology Partner: 
            <a href='https://sriyog.com/consulting' className='hover:text-[#ccc] duration-500'> SRIYOG Consulting, Kathmandu</a>
          </p>
        </div>
      </section>
    </>
