...
<title>Donate Us | Krishna Ganga Rehabilitation Center | HOPE TRUST</title>
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<section class="process-section anim-section text-center">
								...
								<p class="text-center">
									<a data-toggle="modal" href="external.html" data-target=".join-now-form" class="btn btn-default btn-lg join-today">JOIN TODAY</a>
								</p>
							</section>
							<!-- Process Step Section End Here-->
						</div>
                                <div class="col-xs-12 col-sm-12">
							<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSc7JvpJVKCG-jb2m7JLt967YKX4B_blxBg86ff0j0zaNjQ1VQ/viewform?embedded=true" width="1140" height="500" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
					</div>
				</div>
